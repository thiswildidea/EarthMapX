<template>
	<div class="layout-navbars-breadcrumb-user" :style="{ flex: layoutUserFlexNum }">
		...
		<div class="layout-navbars-breadcrumb-user-icon" @click="onDonationClick">
			<i class="esri-icon-donate" :title="$t('message.user.donation')"></i>
		</div>
...
import Donation from '/@/layout/navBars/breadcrumb/donation.vue';
export default {
	name: 'layoutBreadcrumbUser',
	components: { Search, Donation },
	setup() {
		const { t } = useI18n();
		...
		const onDonationClick = () => {
          donationRef.value.showDonateDialog();
		};
