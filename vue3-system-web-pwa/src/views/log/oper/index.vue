        ...
        <el-card shadow="always">
            ...
            >
                ...
                <el-table-column
                        ...
                        <el-tag
                                :type="businessTypeFilter(scope.row)"
                                disable-transitions
                ...
                >
                    <template #default="scope">
                        <span>{{ dateStrFormat(scope.row.operTime) }}</span>
                    </template>
                </el-table-column>
                <el-table-column
                        label="操作"
...
<script lang="ts">
    ...
    export default {
        ...
        setup() {
            ...
            const businessTypeFilter=(row: any)=>{
               return proxy.selectDictlistClass(state.typeOptions, row.businessType);
            }
